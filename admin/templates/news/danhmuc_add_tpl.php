     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
            <label>Màu nền :</label>
            <div class="formRight">
                <input type="text" name="photo" value="<?=@$item['photo']?>" class="input form-control short_input cp3" />
            </div>
            <div class="clear"></div>    
        </div>
        <style>
        ...
        <script>
            $(document).ready(function() {
                $('#picker').css('border-right','20px solid #<?=@$item['photo']?>');
                $('#picker').css('border-color','#<?=@$item['photo']?>'); 
            });
        </script>
        <script type="text/javascript">
